...
2. 依赖、权限或数据流发生变化时，同步更新隐私说明和第三方依赖声明；
3. 运行：
...
4. 推送 Tag；
5. `.github/workflows/release.yml` 重新执行测试、构建并验证签名 APK，然后创建 GitHub Release；
...
- Release 附件、README、LICENSE、NOTICE、PRIVACY 和仓库内的 THIRD_PARTY_NOTICES 可匿名访问。
